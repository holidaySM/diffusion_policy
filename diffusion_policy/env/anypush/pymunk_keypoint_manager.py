...
class PymunkKeypointManager:
    ...
    @classmethod
    def create_from_anypush_env(cls, env, n_block_kps=9, n_agent_kps=3, seed=0, object_name='a', **kwargs):
        ...
        for name in ['block','agent']:
            ...
            if name == 'agent':
                ...
                self.block = obj = self.add_object((256, 300), 0, object_name=object_name)
                n_kps = n_block_kps
