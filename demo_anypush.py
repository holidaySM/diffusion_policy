...
from diffusion_policy.env.anypush.anypush_keypoints_env import AnyPushKeypointsEnv
import pygame
...
@click.option('-obj', '--object_name', default='t')
def main(output, render_size, control_hz, object_name):
    """
    ...
    kp_kwargs = AnyPushKeypointsEnv.genenerate_keypoint_manager_params(object_name=object_name)
    env = AnyPushKeypointsEnv(render_size=render_size, render_action=False, object_name=object_name, **kp_kwargs)
